...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post order_details_url, params: { order_detail: { amount: @order_detail.amount, comment: @order_detail.comment, item: @order_detail.item, order_id: @order_detail.order_id, price: @order_detail.price, user_id: @order_detail.user_id } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { amount: @order_detail.amount, comment: @order_detail.comment, item: @order_detail.item, order_id: @order_detail.order_id, price: @order_detail.price, user_id: @order_detail.user_id } }
